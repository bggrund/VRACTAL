...
namespace UnityEngine {
    public static class Mathd {
        ...
        public static Vector2 toDS(this double val, int method = 0)
        {
            if(val == 0)
            {
                return Vector2.zero;
            ...
            if(method == 0)
            {
                ...
                tempVal = (int)(tempVal * 1000000);
                tempVal /= 1000000 * Pow(10, numTimes10);

                return new Vector2((float)tempVal, (float)(val - tempVal));
            }
            else
            {
