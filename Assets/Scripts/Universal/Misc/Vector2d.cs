...
namespace UnityEngine {
    public struct Vector2d {
        ...
        public static explicit operator Vector2d(Vector2 vf)
        {
            return new Vector2d(vf.x, vf.y);
        }

        public static explicit operator Vector2(Vector2d vd)
        {
            return new Vector2((float)vd.x, (float)vd.y);
        }

        public static Vector2d operator -(Vector2d v2d, Vector2 v2f)
        {
            return new Vector2d(v2d.x - v2f.x, v2d.y - v2f.y);
        }
